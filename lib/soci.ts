...
export const soci: SOCiHighlight[] = [
  ...
  },
  {
    ...
    body: "Recognized by leadership including the CTO for technical depth, AI-native instincts, and cross-functional impact. Currently building the kind of work that makes the case for an AI Product Manager / AI Technical Product Leader role — internally and externally.",
